...
Vue.filter('formatDate', function(str){
  ...
  else if(time/60000 < 60) return parseInt(time/60000) + '分钟前'
  else if(time/3600000 < 24) return parseInt(time/3600000) + '小时前'
  else if(time/86400000 < 31) return parseInt(time/86500000) + '天前'
  else if(time/2592000000 < 12) return parseInt(time/2592000000) + '月前'
  else return parseInt(time/315360000000) + '年前'
})
